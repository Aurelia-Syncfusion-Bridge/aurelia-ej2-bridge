...
export class EjRadioButton extends EjRadioButtonModel implements RadioButtonModel {
  ...
  private cssClassChanged(newValue: any) {
    if (this._wrapped) {
  ...
  private labelChanged(newValue: any, _oldValue: any) {
    if (this._wrapped) {
  ...
  private positionChanged(newValue: string, oldValue: any) {
    if (this._wrapped) {
  ...
  public enableHtmlSanitizerChanged(newValue: any, _oldValue: any) {
    if (this._wrapped) {
