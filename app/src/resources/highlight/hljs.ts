import { customElement, bindable, containerless, Loader, DOM, PLATFORM, autoinject } from 'aurelia-framework';
...
export class Hljs {
    ...
    private highlight(data: string): any /*hljs.IHighlightResultBase*/ {
    ...
    private loadTheme(theme: string) {
        const css: string = `highlight.js/styles/${theme}.css`;
        this.loader.loadText(css).then(text => {
